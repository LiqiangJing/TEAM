...
#     path_to_pkl='/home/matongqing/bart/Dataset/train_objv2.pkl'
#     path_to_data_df='/home/matongqing/bart/Dataset/val_df.tsv'
...
#     with open('valid_adjv3.pkl','wb') as f_save:
...
if __name__ == '__main__':
    adj = open('train_obj.pkl', 'rb')
    adj = pickle.load(adj)
    print(adj['685908290010742784'])
