...
class ViT(nn.Module):
    def __init__(self, *,image_size=224, patch_size=32, num_classes=10, dim=768, depth=1, heads=16, mlp_dim=2048, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
...
if __name__ == '__main__':
    model = ViT(image_size=224, patch_size=32, num_classes=10, dim=768, depth=1, heads=16, mlp_dim=2048)
    pic = torch.rand(64,3,224,224)
    pred = model(pic)
    print(pred.shape)
    print(pred.dim())